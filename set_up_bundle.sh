...
rm -fr $LIFERAY_HOME_PARENT_DIR/$DESIRED_HOME_DIR_NAME &
...
rm -fr $LIFERAY_HOME_PARENT_DIR/temp $LIFERAY_HOME_PARENT_DIR/$DESIRED_HOME_DIR_NAME/patching-tool/ $LIFERAY_HOME_PARENT_DIR/$DESIRED_HOME_DIR_NAME/tomcat-*/temp $LIFERAY_HOME_PARENT_DIR/$DESIRED_HOME_DIR_NAME/tomcat-*/work $LIFERAY_HOME_PARENT_DIR/$DESIRED_HOME_DIR_NAME/work &
